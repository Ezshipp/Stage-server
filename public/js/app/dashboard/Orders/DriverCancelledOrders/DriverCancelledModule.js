...
var DriverCancelledModule = /** @class */ (function () {
    function DriverCancelledModule() {
    }
    DriverCancelledModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], DriverCancelledModule);
    return DriverCancelledModule;
}());
export { DriverCancelledModule };
