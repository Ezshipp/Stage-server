...
var DriverCancelledOrdersComponent = /** @class */ (function () {
    function DriverCancelledOrdersComponent(router, http, _ApiMessageService, _cookieService, ErrorService, cdref) {
        this.router = router;
        this.http = http;
    ...
    DriverCancelledOrdersComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    DriverCancelledOrdersComponent.prototype.pageChanged = function (event) {
        this.views = null;
        this.p = event;
        this.nextpage(this.p - 1);
    };
    DriverCancelledOrdersComponent.prototype.nextpage = function (index) {
        var _this = this;
        this.isRequesting = true;
        this.index = index;
    ...
    DriverCancelledOrdersComponent.prototype.valuechange = function (newValue) {
        var _this = this;
        this.views = null;
    ...
    DriverCancelledOrdersComponent.prototype.OnmoreDetails = function (item, i) {
    ...
    DriverCancelledOrdersComponent.prototype.OnmoreInfo_order = function (item, i) {
        this.views = i;
        this.OnmoreDetails(item, i);
    };
    DriverCancelledOrdersComponent.prototype.onClose_details_View = function () {
        this.views = null;
    };
    DriverCancelledOrdersComponent.prototype.sortColumn = function (key) {
    ...
    DriverCancelledOrdersComponent.prototype.Onselect = function (m, itemss, item) {
        var _this = this;
        this.onselectitem = m;
    ...
    DriverCancelledOrdersComponent.prototype.OnselectCount = function (event) {
        this.limit = event.target.value;
        this.ngOnInit();
        this.p = 1;
    };
    DriverCancelledOrdersComponent = __decorate([
        Component({
    ...
    return DriverCancelledOrdersComponent;
}());
export { DriverCancelledOrdersComponent };
