...
var AllOrdersComponent = /** @class */ (function () {
    function AllOrdersComponent(router, http, _ApiMessageService, _cookieService, ErrorService, cdref, _fb) {
        this.router = router;
        this.http = http;
    ...
    AllOrdersComponent.prototype.pageChanged = function (event) {
        this.p = event;
        this.nextpage(this.p - 1);
        this.views = null;
    };
    AllOrdersComponent.prototype.nextpage = function (index) {
        var _this = this;
        this.isRequesting = true;
        this.index = index;
    ...
    AllOrdersComponent.prototype.valuechange = function (newValue) {
        var _this = this;
        this.views = null;
    ...
    AllOrdersComponent.prototype.edit = function (item, i) {
    ...
    AllOrdersComponent.prototype.OnmoreInfo_order = function (item, i) {
        this.edit(item, i);
        this.order_Index = i;
    };
    AllOrdersComponent.prototype.onClose_details_View = function () {
        this.isdetails_View = false;
    };
    AllOrdersComponent.prototype.change_location_pik = function (item, i) {
        this.edit(item, i);
        this.isedit_pick = true;
    };
    AllOrdersComponent.prototype.change_location_drop = function (item, i) {
        this.edit(item, i);
        this.isedit_drop = true;
        this.show_map_drop = false;
    };
    AllOrdersComponent.prototype.onsubmit_droplocation = function () {
        this.show_map_drop = false;
        this.get_Address(this.dropAddress, 2);
    };
    AllOrdersComponent.prototype.get_Address = function (address, type) {
        var _this = this;
    ...
    AllOrdersComponent.prototype.onsubmit_Edit_drop = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AllOrdersComponent.prototype.onclose_editpick = function () {
        this.isedit_pick = false;
    };
    AllOrdersComponent.prototype.onsubmit_pickUplocation = function () {
        this.show_map_pick = false;
        this.get_Address(this.pickAddress, 1);
    };
    AllOrdersComponent.prototype.pos_pick = function ($event) {
        var pos = ($event);
        this.pickLatitude = pos.coords.lat;
        this.pickLongitude = pos.coords.lng;
    };
    AllOrdersComponent.prototype.onsubmit_Edit_pick = function () {
        var _this = this;
        this.isRequesting = true;
        var body = new OrdersModel_admin(null, null, this.orderId, this.bookingType, this.pickAddress, this.receiverName, this.receiverPhone, this.pickLongitude, this.pickLatitude, this.dropAddress, this.dropLatitude, this.dropLongitude, this.itemName, this.itemDescription, this.itemImage, this.item_actual_cost, this.deliverycharge);
        var headers = new Headers({ 'Content-Type': 'application/json' });
    ...
    AllOrdersComponent.prototype.onclose_editDrop = function () {
        this.isedit_drop = false;
    };
    AllOrdersComponent.prototype.pos_drop = function ($event) {
        var pos = ($event);
        this.dropLatitude = pos.coords.lat;
        this.dropLongitude = pos.coords.lng;
    };
    AllOrdersComponent.prototype.onDelete = function (item, index) {
        this.orderId = item.orderId;
    ...
    AllOrdersComponent.prototype.onClose_Delete = function () {
        this.index_delete = -1;
    };
    AllOrdersComponent.prototype.remove_Order = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AllOrdersComponent.prototype.getvie = function (i, item) {
        this.vietable = i;
        this.testdata = item;
    };
    AllOrdersComponent.prototype.close = function () {
        this.views = -1;
    };
    AllOrdersComponent.prototype.sortColumn = function (key) {
        var backendkey;
        if (this.valu != key) {
            this.valu = key;
            this.IsAsc = true;
    ...
    AllOrdersComponent.prototype.OnchangeStatus = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AllOrdersComponent.prototype.OnchangeStatus_Cancel = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AllOrdersComponent.prototype.onCompleteOrder = function () {
        this.isCompleteOrder = true;
    };
    AllOrdersComponent.prototype.onCancelOrder = function () {
        var _this = this;
    ...
    AllOrdersComponent.prototype.select = function (val, event) {
        var values = val;
        var splitvalue = values.split('/');
        this.ReasonID = splitvalue[0];
        this.Reason = splitvalue[1];
    };
    AllOrdersComponent.prototype.onCloseCancelOrder = function () {
        this.isCancelOrder = false;
    };
    AllOrdersComponent.prototype.onCloseCompleteOrder = function () {
        this.isCompleteOrder = false;
    };
    AllOrdersComponent.prototype.onClickManual = function () {
        var _this = this;
    ...
    AllOrdersComponent.prototype.onCloseManualRoute = function () {
        this.isManualRoute = false;
    };
    AllOrdersComponent.prototype.select_Driver = function (value, event) {
        var bikerD = value;
        var id_name = bikerD.split('/');
        this.DriverID = id_name[0];
        this.Driver_Name = id_name[1];
    };
    AllOrdersComponent.prototype.onSubmitManualRoute = function () {
        var _this = this;
        var body = new OrdersModel_admin(null, null, this.orderId, null, null, null, null, null, null, null, null, null, null, null, null, null, null, this.DriverID, null, null, null, this._cookieService.get('ez_admin_cusID'));
        var headers = new Headers({ 'Content-Type': 'application/json' });
    ...
    AllOrdersComponent.prototype.Onselect = function (m, itemss, item) {
        var _this = this;
        this.onselectitem = m;
    ...
    AllOrdersComponent.prototype.OnselectCount = function (event) {
    ...
    AllOrdersComponent.prototype.click_name_filter = function () {
        this.filter_search_name = !this.filter_search_name;
    };
    AllOrdersComponent.prototype.click_phone_filter = function () {
        this.filter_search_phone = !this.filter_search_phone;
    };
    AllOrdersComponent.prototype.click_biker_filter = function () {
        var _this = this;
    ...
    AllOrdersComponent.prototype.click_filter_view = function () {
        this.click_all_filter = true;
        this.click_all_ordertype = false;
    };
    AllOrdersComponent.prototype.click_ordertype_view = function () {
        this.click_all_ordertype = true;
        this.click_all_filter = false;
    };
    AllOrdersComponent.prototype.clear_filter = function (type) {
        this.click_all_filter = false;
        this.filter_search_phone = false;
        this.filter_search_name = false;
        this.filter_search_date = false;
    ...
    AllOrdersComponent.prototype.onSelectFilter = function (event) {
        this.Name_Query_Type = event;
    };
    AllOrdersComponent.prototype.click_payment_type = function () {
        this.filter_search_payment_type = !this.filter_search_payment_type;
    };
    AllOrdersComponent.prototype.click_date_filter = function () {
        this.filter_search_date = !this.filter_search_date;
    };
    AllOrdersComponent.prototype.payTypeCheck = function (event) {
    ...
    AllOrdersComponent.prototype.bookingType_Filter = function () {
        this.isbookingTypeFilterOptions = !this.isbookingTypeFilterOptions;
    };
    AllOrdersComponent.prototype.bookingTypeCheck = function (event) {
    ...
    AllOrdersComponent.prototype.statusCheck = function (event) {
    ...
    AllOrdersComponent.prototype.capturedCheck = function (event) {
    ...
    AllOrdersComponent.prototype.zone_filter = function () {
        var _this = this;
    ...
    AllOrdersComponent.prototype.drop_zone_filter = function () {
        var _this = this;
    ...
    AllOrdersComponent.prototype.zoneDCheck = function (event, seq, index, title) {
    ...
    AllOrdersComponent.prototype.zonePCheck = function (event, seq, index, title) {
        if (event.target.checked == true) {
            var val = event.target.value;
    ...
    AllOrdersComponent.prototype.filterApply = function () {
        var _this = this;
        this.views = null;
    ...
    AllOrdersComponent.prototype.click_to_clear = function () {
        this.fiterElementsActive = false;
        this.clear_filter(1);
        this.ngOnInit();
    };
    AllOrdersComponent.prototype.onCloseDriverAssign = function () {
        this.isAssignDriver = false;
    };
    AllOrdersComponent.prototype.select_Biker = function (name, id) {
        this.filterBiker = name;
        this.DriverID = id;
        this.isAssignDriver = false;
        this.Whether_Driver_Filter = true;
    };
    AllOrdersComponent.prototype.clearFilterSpecific = function (value) {
        if (value == 1) {
            this.Whether_Name_Filter = false;
            this.filterName = "";
    ...
    AllOrdersComponent.prototype.refresh = function () {
        if (this.Whether_Name_Filter == false && this.Whether_PhoneNumber_Filter == false
            && this.Whether_New_Jobs_Filter == false && this.Whether_Ongoing_Jobs_Filter == false &&
            this.Whether_Completed_Jobs_Filter == false && this.Whether_Expired_Jobs_Filter == false &&
            this.Whether_Date_Filter == false && this.Whether_Driver_Filter == false && this.Whether_Online_Filter == false && this.Whether_Cash_Filter == false
    ...
    AllOrdersComponent.prototype.onCloseNotifyRoute = function () {
        this.isNotifyRoute = false;
    };
    AllOrdersComponent.prototype.onNotifyManual = function (status) {
        if (status == 1)
    ...
    AllOrdersComponent.prototype.onSubmitNotifyRoute = function (selecteduserinfo, textmessage, orderid) {
        var _this = this;
