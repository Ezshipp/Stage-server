...
var AgentAllOrdersComponent = /** @class */ (function () {
    function AgentAllOrdersComponent(router, http, _ApiMessageService, _cookieService, ErrorService, cdref, _fb) {
        this.router = router;
        this.http = http;
    ...
    AgentAllOrdersComponent.prototype.ngOnInit = function () {
    ...
    AgentAllOrdersComponent.prototype.pageChanged = function (event) {
        this.p = event;
        this.nextpage(this.p - 1);
        this.views = null;
    };
    AgentAllOrdersComponent.prototype.nextpage = function (index) {
        var _this = this;
        this.isRequesting = true;
        this.index = index;
    ...
    AgentAllOrdersComponent.prototype.valuechange = function (newValue) {
        var _this = this;
        this.views = null;
    ...
    AgentAllOrdersComponent.prototype.edit = function (item, i) {
    ...
    AgentAllOrdersComponent.prototype.OnmoreInfo_order = function (item, i) {
        this.edit(item, i);
        this.order_Index = i;
    };
    AgentAllOrdersComponent.prototype.onClose_details_View = function () {
        this.isdetails_View = false;
    };
    AgentAllOrdersComponent.prototype.change_location_pik = function (item, i) {
        this.edit(item, i);
        this.isedit_pick = true;
    };
    AgentAllOrdersComponent.prototype.change_location_drop = function (item, i) {
        this.edit(item, i);
        this.isedit_drop = true;
        this.show_map_drop = false;
    };
    AgentAllOrdersComponent.prototype.onsubmit_droplocation = function () {
        this.show_map_drop = false;
        this.get_Address(this.dropAddress, 2);
    };
    AgentAllOrdersComponent.prototype.get_Address = function (address, type) {
        var _this = this;
    ...
    AgentAllOrdersComponent.prototype.onsubmit_Edit_drop = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AgentAllOrdersComponent.prototype.onclose_editpick = function () {
        this.isedit_pick = false;
    };
    AgentAllOrdersComponent.prototype.onsubmit_pickUplocation = function () {
        this.show_map_pick = false;
        this.get_Address(this.pickAddress, 1);
    };
    AgentAllOrdersComponent.prototype.pos_pick = function ($event) {
        var pos = ($event);
        this.pickLatitude = pos.coords.lat;
        this.pickLongitude = pos.coords.lng;
    };
    AgentAllOrdersComponent.prototype.onsubmit_Edit_pick = function () {
        var _this = this;
        this.isRequesting = true;
        var body = new OrdersModel_admin(null, null, this.orderId, this.bookingType, this.pickAddress, this.receiverName, this.receiverPhone, this.pickLongitude, this.pickLatitude, this.dropAddress, this.dropLatitude, this.dropLongitude, this.itemName, this.itemDescription, this.itemImage, this.item_actual_cost, this.deliverycharge);
        var headers = new Headers({ 'Content-Type': 'application/json' });
    ...
    AgentAllOrdersComponent.prototype.onclose_editDrop = function () {
        this.isedit_drop = false;
    };
    AgentAllOrdersComponent.prototype.pos_drop = function ($event) {
        var pos = ($event);
        this.dropLatitude = pos.coords.lat;
        this.dropLongitude = pos.coords.lng;
    };
    AgentAllOrdersComponent.prototype.onDelete = function (item, index) {
        this.orderId = item.orderId;
    ...
    AgentAllOrdersComponent.prototype.onClose_Delete = function () {
        this.index_delete = -1;
    };
    AgentAllOrdersComponent.prototype.remove_Order = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AgentAllOrdersComponent.prototype.getvie = function (i, item) {
        this.vietable = i;
        this.testdata = item;
    };
    AgentAllOrdersComponent.prototype.close = function () {
        this.views = -1;
    };
    AgentAllOrdersComponent.prototype.sortColumn = function (key) {
        console.log("kde" + key);
        var backendkey;
        if (this.valu != key) {
            this.valu = key;
    ...
    AgentAllOrdersComponent.prototype.OnchangeStatus = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AgentAllOrdersComponent.prototype.OnchangeStatus_Cancel = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    AgentAllOrdersComponent.prototype.onCompleteOrder = function () {
        this.isCompleteOrder = true;
    };
    AgentAllOrdersComponent.prototype.onCancelOrder = function () {
        var _this = this;
    ...
    AgentAllOrdersComponent.prototype.select = function (val, event) {
        var values = val;
        var splitvalue = values.split('/');
        this.ReasonID = splitvalue[0];
        this.Reason = splitvalue[1];
    };
    AgentAllOrdersComponent.prototype.onCloseCancelOrder = function () {
        this.isCancelOrder = false;
    };
    AgentAllOrdersComponent.prototype.onCloseCompleteOrder = function () {
        this.isCompleteOrder = false;
    };
    AgentAllOrdersComponent.prototype.onClickManual = function () {
        var _this = this;
    ...
    AgentAllOrdersComponent.prototype.onCloseManualRoute = function () {
        this.isManualRoute = false;
    };
    AgentAllOrdersComponent.prototype.select_Driver = function (value, event) {
        var bikerD = value;
        var id_name = bikerD.split('/');
        this.DriverID = id_name[0];
        this.Driver_Name = id_name[1];
    };
    AgentAllOrdersComponent.prototype.onSubmitManualRoute = function () {
        var _this = this;
        var body = new OrdersModel_admin(null, null, this.orderId, null, null, null, null, null, null, null, null, null, null, null, null, null, null, this.DriverID, null, null, null, this._cookieService.get('ez_admin_cusID'));
        var headers = new Headers({ 'Content-Type': 'application/json' });
    ...
    AgentAllOrdersComponent.prototype.Onselect = function (m, itemss, item) {
        var _this = this;
        this.onselectitem = m;
    ...
    AgentAllOrdersComponent.prototype.OnselectCount = function (event) {
    ...
    AgentAllOrdersComponent.prototype.click_name_filter = function () {
        this.filter_search_name = !this.filter_search_name;
        // this.filter_search_phone = false
    };
    AgentAllOrdersComponent.prototype.click_phone_filter = function () {
        this.filter_search_phone = !this.filter_search_phone;
        // this.filter_search_name = false
    };
    AgentAllOrdersComponent.prototype.click_biker_filter = function () {
        var _this = this;
    ...
    AgentAllOrdersComponent.prototype.click_filter_view = function () {
        this.click_all_filter = true;
        this.click_all_ordertype = false;
    };
    AgentAllOrdersComponent.prototype.click_ordertype_view = function () {
        this.click_all_ordertype = true;
        this.click_all_filter = false;
    };
    AgentAllOrdersComponent.prototype.clear_filter = function (type) {
        this.click_all_filter = false;
        this.filter_search_phone = false;
        this.filter_search_name = false;
        this.filter_search_date = false;
    ...
    AgentAllOrdersComponent.prototype.onSelectFilter = function (event) {
        this.Name_Query_Type = event;
        // console.log("Name_Query_Type " + this.Name_Query_Type);
    };
    AgentAllOrdersComponent.prototype.click_payment_type = function () {
        this.filter_search_payment_type = !this.filter_search_payment_type;
    };
    AgentAllOrdersComponent.prototype.click_date_filter = function () {
        this.filter_search_date = !this.filter_search_date;
    };
    AgentAllOrdersComponent.prototype.payTypeCheck = function (event) {
    ...
    AgentAllOrdersComponent.prototype.bookingType_Filter = function () {
        this.isbookingTypeFilterOptions = !this.isbookingTypeFilterOptions;
    };
    AgentAllOrdersComponent.prototype.bookingTypeCheck = function (event) {
    ...
    AgentAllOrdersComponent.prototype.statusCheck = function (event) {
    ...
    AgentAllOrdersComponent.prototype.capturedCheck = function (event) {
    ...
    AgentAllOrdersComponent.prototype.filterApply = function () {
        var _this = this;
        this.views = null;
        this.CLEAR_ALL = false;
        this.isRequesting = true;
    ...
    AgentAllOrdersComponent.prototype.click_to_clear = function () {
        this.fiterElementsActive = false;
        this.clear_filter(1);
        // this.sortOptions = {}
        this.ngOnInit();
    };
    AgentAllOrdersComponent.prototype.onCloseDriverAssign = function () {
        this.isAssignDriver = false;
    };
    AgentAllOrdersComponent.prototype.select_Biker = function (name, id) {
    ...
    AgentAllOrdersComponent.prototype.clearFilterSpecific = function (value) {
        if (value == 1) {
            this.Whether_Name_Filter = false;
            this.filterName = "";
    ...
    AgentAllOrdersComponent.prototype.refresh = function () {
        if (this.Whether_Name_Filter == false && this.Whether_PhoneNumber_Filter == false
            && this.Whether_New_Jobs_Filter == false && this.Whether_Ongoing_Jobs_Filter == false &&
            this.Whether_Completed_Jobs_Filter == false && this.Whether_Expired_Jobs_Filter == false &&
            this.Whether_Date_Filter == false && this.Whether_Driver_Filter == false && this.Whether_Online_Filter == false && this.Whether_Cash_Filter == false
    ...
    AgentAllOrdersComponent = __decorate([
        Component({
            selector: 'app-all',
            templateUrl: "./agentallorders.component.html",
            animations: [
                trigger('itemAnim', [
                    transition(':enter', [
            ...
            styleUrls: ["./agentallorders.component.css"]
        }),
    ...
    return AgentAllOrdersComponent;
}());
export { AgentAllOrdersComponent };
