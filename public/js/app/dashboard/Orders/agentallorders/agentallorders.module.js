...
var AgentAllordersModule = /** @class */ (function () {
    function AgentAllordersModule() {
    }
    AgentAllordersModule = __decorate([
        NgModule({
            declarations: [
    ...
    ], AgentAllordersModule);
    return AgentAllordersModule;
}());
export { AgentAllordersModule };
