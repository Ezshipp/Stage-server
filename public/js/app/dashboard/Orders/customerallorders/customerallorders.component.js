...
var CustomerAllOrdersComponent = /** @class */ (function () {
    function CustomerAllOrdersComponent(router, http, _ApiMessageService, _cookieService, ErrorService, cdref, _fb) {
        this.router = router;
        this.http = http;
    ...
    CustomerAllOrdersComponent.prototype.ngOnInit = function () {
    ...
    CustomerAllOrdersComponent.prototype.pageChanged = function (event) {
        this.p = event;
        this.nextpage(this.p - 1);
        this.views = null;
    };
    CustomerAllOrdersComponent.prototype.nextpage = function (index) {
        var _this = this;
        this.isRequesting = true;
        this.index = index;
    ...
    CustomerAllOrdersComponent.prototype.valuechange = function (newValue) {
        var _this = this;
        this.views = null;
    ...
    CustomerAllOrdersComponent.prototype.edit = function (item, i) {
    ...
    CustomerAllOrdersComponent.prototype.OnmoreInfo_order = function (item, i) {
        this.edit(item, i);
        this.order_Index = i;
    };
    CustomerAllOrdersComponent.prototype.onClose_details_View = function () {
        this.isdetails_View = false;
    };
    CustomerAllOrdersComponent.prototype.change_location_pik = function (item, i) {
        this.edit(item, i);
        this.isedit_pick = true;
    };
    CustomerAllOrdersComponent.prototype.change_location_drop = function (item, i) {
        this.edit(item, i);
        this.isedit_drop = true;
        this.show_map_drop = false;
    };
    CustomerAllOrdersComponent.prototype.onsubmit_droplocation = function () {
        this.show_map_drop = false;
        this.get_Address(this.dropAddress, 2);
    };
    CustomerAllOrdersComponent.prototype.get_Address = function (address, type) {
        var _this = this;
    ...
    CustomerAllOrdersComponent.prototype.onsubmit_Edit_drop = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    CustomerAllOrdersComponent.prototype.onclose_editpick = function () {
        this.isedit_pick = false;
    };
    CustomerAllOrdersComponent.prototype.onsubmit_pickUplocation = function () {
        this.show_map_pick = false;
        this.get_Address(this.pickAddress, 1);
    };
    CustomerAllOrdersComponent.prototype.pos_pick = function ($event) {
        var pos = ($event);
        this.pickLatitude = pos.coords.lat;
        this.pickLongitude = pos.coords.lng;
    };
    CustomerAllOrdersComponent.prototype.onsubmit_Edit_pick = function () {
        var _this = this;
        this.isRequesting = true;
        var body = new OrdersModel_admin(null, null, this.orderId, this.bookingType, this.pickAddress, this.receiverName, this.receiverPhone, this.pickLongitude, this.pickLatitude, this.dropAddress, this.dropLatitude, this.dropLongitude, this.itemName, this.itemDescription, this.itemImage, this.item_actual_cost, this.deliverycharge);
        var headers = new Headers({ 'Content-Type': 'application/json' });
    ...
    CustomerAllOrdersComponent.prototype.onclose_editDrop = function () {
        this.isedit_drop = false;
    };
    CustomerAllOrdersComponent.prototype.pos_drop = function ($event) {
        var pos = ($event);
        this.dropLatitude = pos.coords.lat;
        this.dropLongitude = pos.coords.lng;
    };
    CustomerAllOrdersComponent.prototype.onDelete = function (item, index) {
        this.orderId = item.orderId;
    ...
    CustomerAllOrdersComponent.prototype.onClose_Delete = function () {
        this.index_delete = -1;
    };
    CustomerAllOrdersComponent.prototype.remove_Order = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    CustomerAllOrdersComponent.prototype.getvie = function (i, item) {
        this.vietable = i;
        this.testdata = item;
    };
    CustomerAllOrdersComponent.prototype.close = function () {
        this.views = -1;
    };
    CustomerAllOrdersComponent.prototype.sortColumn = function (key) {
        console.log("kde" + key);
        var backendkey;
        if (this.valu != key) {
            this.valu = key;
    ...
    CustomerAllOrdersComponent.prototype.OnchangeStatus = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    CustomerAllOrdersComponent.prototype.OnchangeStatus_Cancel = function () {
        var _this = this;
        this.isRequesting = true;
    ...
    CustomerAllOrdersComponent.prototype.onCompleteOrder = function () {
        this.isCompleteOrder = true;
    };
    CustomerAllOrdersComponent.prototype.onCancelOrder = function () {
        var _this = this;
    ...
    CustomerAllOrdersComponent.prototype.select = function (val, event) {
        var values = val;
        var splitvalue = values.split('/');
        this.ReasonID = splitvalue[0];
        this.Reason = splitvalue[1];
    };
    CustomerAllOrdersComponent.prototype.onCloseCancelOrder = function () {
        this.isCancelOrder = false;
    };
    CustomerAllOrdersComponent.prototype.onCloseCompleteOrder = function () {
        this.isCompleteOrder = false;
    };
    CustomerAllOrdersComponent.prototype.onClickManual = function () {
        var _this = this;
    ...
    CustomerAllOrdersComponent.prototype.onCloseManualRoute = function () {
        this.isManualRoute = false;
    };
    CustomerAllOrdersComponent.prototype.select_Driver = function (value, event) {
        var bikerD = value;
        var id_name = bikerD.split('/');
        this.DriverID = id_name[0];
        this.Driver_Name = id_name[1];
    };
    CustomerAllOrdersComponent.prototype.onSubmitManualRoute = function () {
        var _this = this;
        var body = new OrdersModel_admin(null, null, this.orderId, null, null, null, null, null, null, null, null, null, null, null, null, null, null, this.DriverID, null, null, null, this._cookieService.get('ez_admin_cusID'));
        var headers = new Headers({ 'Content-Type': 'application/json' });
    ...
    CustomerAllOrdersComponent.prototype.Onselect = function (m, itemss, item) {
        var _this = this;
        this.onselectitem = m;
    ...
    CustomerAllOrdersComponent.prototype.OnselectCount = function (event) {
    ...
    CustomerAllOrdersComponent.prototype.click_name_filter = function () {
        this.filter_search_name = !this.filter_search_name;
        // this.filter_search_phone = false
    };
    CustomerAllOrdersComponent.prototype.click_phone_filter = function () {
        this.filter_search_phone = !this.filter_search_phone;
        // this.filter_search_name = false
    };
    CustomerAllOrdersComponent.prototype.click_biker_filter = function () {
        var _this = this;
    ...
    CustomerAllOrdersComponent.prototype.click_filter_view = function () {
        this.click_all_filter = true;
        this.click_all_ordertype = false;
    };
    CustomerAllOrdersComponent.prototype.click_ordertype_view = function () {
        this.click_all_ordertype = true;
        this.click_all_filter = false;
    };
    CustomerAllOrdersComponent.prototype.clear_filter = function (type) {
        this.click_all_filter = false;
        this.filter_search_phone = false;
        this.filter_search_name = false;
        this.filter_search_date = false;
    ...
    CustomerAllOrdersComponent.prototype.onSelectFilter = function (event) {
        this.Name_Query_Type = event;
        // console.log("Name_Query_Type " + this.Name_Query_Type);
    };
    CustomerAllOrdersComponent.prototype.click_payment_type = function () {
        this.filter_search_payment_type = !this.filter_search_payment_type;
    };
    CustomerAllOrdersComponent.prototype.click_date_filter = function () {
        this.filter_search_date = !this.filter_search_date;
    };
    CustomerAllOrdersComponent.prototype.payTypeCheck = function (event) {
    ...
    CustomerAllOrdersComponent.prototype.bookingType_Filter = function () {
        this.isbookingTypeFilterOptions = !this.isbookingTypeFilterOptions;
    };
    CustomerAllOrdersComponent.prototype.bookingTypeCheck = function (event) {
    ...
    CustomerAllOrdersComponent.prototype.statusCheck = function (event) {
    ...
    CustomerAllOrdersComponent.prototype.capturedCheck = function (event) {
    ...
    CustomerAllOrdersComponent.prototype.filterApply = function () {
        var _this = this;
        this.views = null;
        this.CLEAR_ALL = false;
        this.isRequesting = true;
    ...
    CustomerAllOrdersComponent.prototype.click_to_clear = function () {
        this.fiterElementsActive = false;
        this.clear_filter(1);
        // this.sortOptions = {}
        this.ngOnInit();
    };
    CustomerAllOrdersComponent.prototype.onCloseDriverAssign = function () {
        this.isAssignDriver = false;
    };
    CustomerAllOrdersComponent.prototype.select_Biker = function (name, id) {
    ...
    CustomerAllOrdersComponent.prototype.clearFilterSpecific = function (value) {
        if (value == 1) {
            this.Whether_Name_Filter = false;
            this.filterName = "";
    ...
    CustomerAllOrdersComponent.prototype.refresh = function () {
        if (this.Whether_Name_Filter == false && this.Whether_PhoneNumber_Filter == false
            && this.Whether_New_Jobs_Filter == false && this.Whether_Ongoing_Jobs_Filter == false &&
            this.Whether_Completed_Jobs_Filter == false && this.Whether_Expired_Jobs_Filter == false &&
            this.Whether_Date_Filter == false && this.Whether_Driver_Filter == false && this.Whether_Online_Filter == false && this.Whether_Cash_Filter == false
    ...
    CustomerAllOrdersComponent = __decorate([
        Component({
            selector: 'app-all',
            templateUrl: "./customerallorders.component.html",
            animations: [
                trigger('itemAnim', [
                    transition(':enter', [
            ...
            styleUrls: ["./customerallorders.component.css"]
        }),
    ...
    return CustomerAllOrdersComponent;
}());
export { CustomerAllOrdersComponent };
