...
export class CancelReasonsComponent implements OnInit {
  ...
  ReasonData: any = [];
  url: string = '';
  constructor(private router: Router, private http: Http, private _ApiMessageService: ApiMessageService, private _cookieService: CookieService, private ErrorService: ErrorService,
