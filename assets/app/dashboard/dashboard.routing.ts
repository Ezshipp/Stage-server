...
import { DriverCancelledOrdersComponent } from "./Orders/DriverCancelledOrders/DriverCancelledOrders.component";
...
const DASHBOARD1: Routes = [
  ...
  },
  {
    path: "expired",
    loadChildren:
      "./Orders/ExpiredOrders/expiredOrders.module#ExpiredOrdersModule"
  },
  {
    path: "NewQueOrders",
  ...
  },
  {
    path: "completed",
    loadChildren:
      "./Orders/completedOrders/completedorders.module#CompletedOrdersModule",
    data: { state: "active_Customer" }
  },
  {
    path: "active_Customer",
    loadChildren:
      "./customer/activeCustomers/activeCustomer.module#ActiveCustomerodule#InactiveCustomerModule",
    data: { state: "in_active_Customer" }
  },
  {
    path: "in_active_Customer",
    loadChildren:
      "./customer/InactiveCustomers/inactiveCustomer.module#InactiveCustomerModule",
    data: { state: "customer_Reason" }
  },
  {
    path: "customer_Reason",
    loadChildren:
      "./customer/customerCancelReasons/customerCancelReasons.module#CustomerCancelModule",
    data: { state: "report" }
  },
  {
    path: "analytics",
  ...
  },
  {
    path: "O_D_report",
    loadChildren:
      "./o.DeliveryReport/o.DeliveryReport.module#O_Delivery_ReportModule",
  ...
  },
  {
    path: "BirdsView",
    loadChildren:
      "./drivers-bird-view/drivers-bird-view.module#DriversBirdViewModule",
    data: { state: "BirdsView" }
  },
  {
    path: "drviver_c",
    loadChildren:
      "./Orders/DriverCancelledOrders/DriverCancelledModule#DriverCancelledModule",
  ...
  },
  {
    path: "Promotaional_C",
    loadChildren:
      "./PromotationContacts/PromotationContacts.module#PromotionalContactsModule",
    data: { state: "Promotaional_C" }
  },
  {
    path: "onGoingBikers",
    loadChildren:
      "./Drivers/on-going-bikers/on-going-bikers.module#OnGoingBikersModule",
  ...
  },
  {
    ...
    loadChildren:
      "./customer/premiumCustomer/premiumCustomer.module#PremiumCustomerModule",
...
export const dashboardRouting: ModuleWithProviders = RouterModule.forChild(DASHBOARD1);
